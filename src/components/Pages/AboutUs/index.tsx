  ...
  return (
    <Container>
      <div
        ...
        } bg-secondary-300 w-full h-[100%] p-5`}
      >
        <Typography text="Sobre Nós" className="text-secondary-100" type="h1" />
        <div
        ...
        >
          <div className="flex flex-col justify-center items-center w-full h-[100%]">
            <Typography
              ...
              className={`tracking-wide text-secondary-100 text-justify pb-5`}
            />
            {width <= 850 && (
            ...
            <Typography
              ...
              className="text-secondary-100 text-justify pb-5 tracking-wide"
            />
            <Typography
        ...
        <div
          className={`flex justify-center bg-secondary-50 rounded p-3 border ${
        ...
        >
          <div className="flex flex-col gap-4 w-full text-center">
            <Typography
              text="Nossa Missão"
              className="text-secondary-100 tracking-wide"
              type="h2"
            />
            <Typography
              ...
              className="text-secondary-100 text-justify tracking-wide p-5 pt-2"
            />
          </div>
          <div className="flex flex-col gap-4 w-full text-center">
            <Typography
              ...
              type="h2"
            />
            <ul className="flex flex-col text-secondary-100 text-[18px] text-left p-5 pt-2 gap-3 list-disc list-inside">
              <li>Inovação</li>
