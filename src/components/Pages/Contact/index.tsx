  ...
  return (
    <Container>
      <div
        ...
        } flex flex-col bg-secondary-300 w-full p-5 gap-6`}
      >
        <Typography type="h1" text="Contato" className="text-secondary-100" />
        <Typography
        ...
        >
          <div className="w-12 bg-primary-50 rounded-full">
            <Image
              src="/whatsappPB.svg"
              alt="WhatsApp"
              width={20}
          ...
          <Typography text="(37)99988-1788" className="text-secondary-100" />
        </a>
        <a
        ...
        >
          ...
          <Typography text="(37)3322-1787" className="text-secondary-100" />
        </a>
        <Typography
          text="Preencha o formulário de e-mail e entraremos em contato com você."
          className="text-secondary-100"
        />
        <div className="w-full bg-secondary-100 rounded min-h-[330px] p-3">
          <form
          ...
          >
            ...
            <textarea
              ...
              placeholder="Assunto"
              className="bg-secondary-160 p-3 rounded resize-none"
              rows={5}
              onChange={(ev) => {
                return setFormFields((oldFields) => {
                  return {
        ...
        <div className="flex w-full items-center justify-center">
          <div className="flex items-center justify-center bg-primary-50 rounded w-28 h-10">
            {!loading ? (
              <input
                type="submit"
                placeholder="enviar"
                className="cursor-pointer text-secondary-100 text-xl uppercase"
