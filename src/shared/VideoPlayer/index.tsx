...
const VideoPlayer = ({ src, poster }: Props) => {
  ...
  return (
    <div className="flex flex-col w-[90%]">
      ...
      />
      <div className="flex items-center justify-between bg-[#404040] py-2 px-3 gap-2">
        <button onClick={toggleVideoPlay} className="w-6 h-6">
          <Image
            src={playerState.playing ? "/play.png" : "/pause.png"}
        ...
        >
          <Image
            src={playerState.volume ? "/volume.png" : "/semvolume.png"}
        ...
        <div className="flex items-center w-10 h-full">
          <Image src="/logoIcon.png" width={50} height={50} alt="Logo" />
        </div>
      </div>
    </div>
  );
